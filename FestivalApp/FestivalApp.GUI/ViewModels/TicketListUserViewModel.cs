...
{
    public class TicketListUserViewModel : ViewModelBase, IViewModel
    {
        ...
        public TicketListUserViewModel(TicketRepository ticketRepository)
        {
            _ticketRepository = ticketRepository;

            Mediator.Instance.Register<TicketReloadMessage>(ReloadTickets);
            Mediator.Instance.Register<TicketsLoadByUserMessage>(SetUserId);
        ...
        public void SetUserId(TicketsLoadByUserMessage message)
        {
            UserId = message.Id;
            Load();
        }
        ...
        {
            Tickets.Clear();
            var tickets = _ticketRepository.GetByUser(UserId);
